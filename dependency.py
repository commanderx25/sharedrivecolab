...
def setup_environment(ForceUpdateDependencies, ForceTemporaryStorage):
    ...
    if ForceTemporaryStorage:
        ...
        file_path = '/content/drive/Shareddrives/hdonline/RVC_Cached/CachedRVC.tar.gz'
    ...
    if Path(file_path).exists():
        ...
        os.makedirs('/content/drive/Shareddrives/hdonline/RVC_Cached', exist_ok=True)
        shutil.copy('/content/CachedRVC.tar.gz', '/content/drive/Shareddrives/hdonline/RVC_Cached/CachedRVC.tar.gz')
